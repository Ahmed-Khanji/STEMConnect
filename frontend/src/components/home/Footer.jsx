...
export default function Footer() {
  ...
  const questions = {
    title: t("footer.questions.title", "Questions"),
    links: [
      { label: t("footer.questions.latest", "Latest questions"), href: "#" },
      { label: t("footer.questions.bioChem", "Biology and Chemistry"), href: "#" },
      { label: t("footer.questions.psychSoc", "Psychology and Sociology"), href: "#" },
      { label: t("footer.questions.mgmt", "Management"), href: "#" },
      { label: t("footer.questions.physics", "Physics"), href: "#" },
    ],
  };

  const universities = {
    title: t("footer.universities.title", "University"),
    links: [
      { label: t("footer.universities.usa", "United States of America (USA)"), href: "#" },
      { label: t("footer.universities.ph", "Philippines"), href: "#" },
      { label: t("footer.universities.in", "India"), href: "#" },
      { label: t("footer.universities.vn", "Vietnam"), href: "#" },
      { label: t("footer.universities.uk", "United Kingdom"), href: "#" },
      { label: t("footer.universities.ca", "Canada"), href: "#" },
      { label: t("footer.universities.tr", "Turkey"), href: "#" },
    ],
  };
  ...
  return (
    <footer className="bg-black text-white dark:bg-white dark:text-black">
      <div className="mx-auto max-w-7xl pl-6 pr-4 md:pl-10 md:pr-6 lg:pl-16 lg:pr-8 py-12">
        ...
        {/* Columns */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-12 pt-10">
          <FooterCol title={docs.title} links={docs.links} />
          <FooterCol title={explore.title} links={explore.links} />
          <FooterCol title={questions.title} links={questions.links} />
          <FooterCol title={universities.title} links={universities.links} />
        </div>

        {/* Bottom line */}
        <div className="mt-10 border-t border-white/10 pt-6 text-xs text-white/60 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p>© {new Date().getFullYear()} STEMConnect. {t("footer.rights", "All rights reserved.")}</p>
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/in/ahmedkhanji/" className="hover:text-white">
            ...
            <a href="https://github.com/Ahmed-Khanji/STEMConnect" className="hover:text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
            ...
            <a href="https://www.instagram.com/ak_softwaredev" className="hover:text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor" aria-hidden="true">
